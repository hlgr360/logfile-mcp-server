"""
AI: Core tests for NexusLogDatabase covering essential functionality.
...
class TestNexusDatabase:
    ...
    def temp_db(self, tmp_path):
        ...
        db = NexusLogDatabase(db_connection)
    ...
    @pytest.fixture
    def sample_nexus_data(self):
        """AI: Sample valid nexus log data for testing."""
        return [
            {
                'ip_address': '192.168.1.100',
                'timestamp': datetime(2024, 1, 15, 10, 30, 45),
                'method': 'GET',
                'path': '/nexus/content/repositories/maven-public/test.jar',
                'http_version': 'HTTP/1.1',
                'status_code': 200,
                'response_size': 1234567,
                'request_size': 512,
                'processing_time_ms': 150,
                'user_agent': 'Maven/3.6.3',
                'thread_info': 'qtp1234567890-45',
                'raw_log': '192.168.1.100 - - [15/Jan/2024:10:30:45] "GET /nexus/content/repositories/maven-public/test.jar HTTP/1.1" 200 1234567',
            ...
            },
            {
                ...
                'method': 'POST',
                'path': '/nexus/service/rest/beta/repositories/upload',
                'http_version': 'HTTP/1.1',
                'status_code': 201,
                'response_size': 256,
                'request_size': 2048,
                ...
                'raw_log': '192.168.1.101 - admin [15/Jan/2024:10:31:15] "POST /nexus/service/rest/beta/repositories/upload HTTP/1.1" 201 256',
                'file_source': 'nexus.log'
            }
        ]
    ...
    def test_get_model_class(self, temp_db):
        ...
        assert model_class == NexusLog
    
    def test_batch_insert_success(self, temp_db, sample_nexus_data):
        """AI: Test successful batch insertion of valid data."""
        count = temp_db.batch_insert(sample_nexus_data)
        assert count == 2
    ...
    def test_get_preview_with_data(self, temp_db, sample_nexus_data):
    ...
    def test_get_preview_limit_parameter(self, temp_db, sample_nexus_data):
        """AI: Test that preview respects the limit parameter."""
        # Insert data
        temp_db.batch_insert(sample_nexus_data)
